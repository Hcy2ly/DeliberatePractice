class Magnifier {
  ...
  _onResizeStart = (event) => {
    ...
    this.container.addEventListener("mouseup", this._onResizeEnd);
    this.container.addEventListener("mouseleave", this._onResizeEnd);
  };
  ...
  _onResizeEnd = () => {
    ...
    this.container.removeEventListener("mouseup", this._onResizeEnd);
    this.container.removeEventListener("mouseleave", this._onResizeEnd);
  };
}
